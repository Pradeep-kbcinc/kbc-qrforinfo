<template>
  <v-app-bar border class="px-4 elevation-0" color="white">
    <v-avatar @click="router.push('/')" tile size="40" class="rounded-lg pointer" color="primary">
      <img contain width="25" src="@/assets/QR_white.svg">
    </v-avatar>

    <v-app-bar-title @click="router.push('/')" class="font-weight-black pointer">QRForInfo</v-app-bar-title>
